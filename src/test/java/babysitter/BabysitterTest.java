...
//	}
	...
	@Test
	public void shouldCalculateWagesForFamilyBGivenStartAndEndAfterMidnight() {
	...
	@Test
	public void shouldCalculateWagesForFamilyBGivenStartAfter2200AndEndBeforeMidnight() {
	...
	@Test
	public void shouldCalculateWagesForFamilyBGivenStartAfter2200AndEndAtMidnight() {
		LocalDateTime start = LocalDateTime.of(2018, 12, 13, 22, 0 );
	...
	@Test
	public void shouldCalculateWagesForFamilyBGivenStartBefore2200AndEndBeforeMidnight() {
	...
	@Test
	public void shouldCalculateWagesForFamilyBGivenStartBefore2200AndEndAtMidnight() {
		LocalDateTime start = LocalDateTime.of(2018, 12, 13, 18, 0 );
		LocalDateTime end = LocalDateTime.of(2018, 12, 14, 0, 0);
		int pay = sophie.compute("B", start, end);
		assertEquals(64, pay);
	...
	@Test
	public void shouldCalculateWagesForFamilyBGivenStartBefore2200AndEndAfterMidnight() {
		LocalDateTime start = LocalDateTime.of(2018, 12, 13, 18, 0 );
